...
\theorem{Angular momentum}{
	\begin{equation*}
	    L=I\omega=mvr\sin\theta
	\end{equation*}
	where $L$ is angular momentum, $I$ is moment of inertia and $\omega$ is angular velocity. Angular momentum has units of \si{\kilo\gram\cdot\meter^2\per\second}. Angular momentum is conserved (recall $\sum p_i=\sum p_f$):
	\begin{equation*}
...
\theorem{Angular impulse}{
	\begin{align*}
		...
		&=\Sigma \tau \cdot \Delta t
		=\Sigma \tau \cdot (t_1-t_0) \tag{Constant torque}
	\end{align*}
