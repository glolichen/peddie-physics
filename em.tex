...
\defitheorem{Capacitance}{
	 \textbf{Capacitance} is the slope of a graph of $\Delta V_\text{capacitor}$ against the magnitude of charge $\left|Q\right|$:
	\begin{equation*}
		C
...
\theorem{Energy of capacitor}{
	...
	where:
	\begin{align*}
		U_\text{capacitor}&=\text{energy stored by capacitor (J)}
	\end{align*}
}
