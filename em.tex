...
\textbf{Charging.} At time $t=0$, both plates are neutral and $\left|Q\right|=0$. The capacitor is equivalent to a closed switch (or just wire). At time $t=\infty$, the potential difference of the capacitor is equal to that of the battery. The capacitor is equivalent to a open switch.
