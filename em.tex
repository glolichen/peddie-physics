...
\definition{
	\textbf{Potential difference} ($\Delta V$) is measured in volts (V), and is related to energy.
...
To connect a parallel circuit, multiple junctions need to be made. A junction is where three or more wires are connected.
...
Electrons flow from the negative terminal to the positive terminal. Conventional current is the direction in which positive charges flow, and is opposite to the direction electrons flow.
...
A \textbf{combination circuit} is one which is not purely series or purely parallel. We can analyze such a circuit by calculating the total/equivalent resistance.
